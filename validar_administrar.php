...
$(document).ready(function (){
	$("#actualizaractividades").click(function(){
		$("#actualizar").show('clip');
	});
});
...
<body class="thrColFixHdr" onload="MM_preloadImages('Img/quienes-somos-2.gif','Img/directorio-2.gif','Img/estatu-y-reglame2.gif','Img/circulares-2.gif','Img/contactenos-2.gif');">
...
<div id="container">
      ...
      <div id="menu" >
        <div align="center"><a href="http://www.apf-alemansc.com.bo"><img src="Img/quienes-somos.gif" width="167" height="30" border="0" id="Image1" onmouseover="MM_swapImage('Image1','','Img/quienes-somos-2.gif',1)" onmouseout="MM_swapImgRestore()"/></a><a href="directorio.html"><img src="Img/directorio.gif" width="167" height="30" border="0" id="Image2" onmouseover="MM_swapImage('Image2','','Img/directorio-2.gif',1)" onmouseout="MM_swapImgRestore()"/></a><a href="estatutos.html"><img src="Img/estatuto-y-reglame.gif" width="167" height="30" border="0" id="Image3" onmouseover="MM_swapImage('Image3','','Img/estatu-y-reglame2.gif',1)" onmouseout="MM_swapImgRestore()"/></a><a href="circulares.php"><img src="Img/circulares.gif" width="166" height="30" border="0" id="Image4" onmouseover="MM_swapImage('Image4','','Img/circulares-2.gif',1)" onmouseout="MM_swapImgRestore()"/></a><a href="actividades.php"><img src="Img/contactenos.gif" width="166" height="30" border="0" id="Image5" onmouseover="MM_swapImage('Image5','','Img/contactenos-2.gif',1)" onmouseout="MM_swapImgRestore()"/></a></a><a href="uniformes.php"><img src="Img/poleras.gif" name="poleras" width="167" height="30" border="0" onmouseover="MM_swapImage('poleras','','Img/poleras-2.gif',1)" onmouseout="MM_swapImgRestore()"/></a></div>
  </div>
      <div id="sidebar1">
      ...
      <div id="mainContent" >
        <h3>Admisnistracion General del sitio APF</h3>
		<?php        
			$user=$_POST['usuario'];
			$pass=$_POST['password'];
			$query="SELECT usuario, password, tipo FROM directiva WHERE usuario='".$user."' and password='".$pass."'";
			$resultado=mysql_query($query);		
			if($f=mysql_fetch_array($resultado))
			{
				if ($f["password"]==$pass)
				{
					if($f["tipo"]=="directiva")
					{
						$_SESSION["alias"]=$f['usuario'];
						header("Location: http://www.apf-alemansc.com.bo/circulares.php");						
					}
					else
					{
						$_SESSION["alias"]=$f['usuario'];	
						echo "Bienvenido : ".$user."<br/><br/>";
						echo '<form id="form3" name="form3" method="post" action="actualizar.php">';
						echo '<table  width="500" border="1" bordercolor="#999999" >';
						echo "<tr>";
						echo '<td width="100"><div align="center"><strong>Cargar/Subir</strong></div></td>';
						echo '<td width="150"><div align="center"><strong>Editar/Actualizar</strong></div></td>';       
						echo '</tr>';
						echo '<tr>';		
						echo '<td><div align="center"><a href="subir_archivos.php">Nuevas Circulares</a></div> </td>';
						echo '<td><div align="center"><input type="submit" name="actualizarcirculares" id="actualizarcirculares" onclick="actualizar.php" value="Actualizar / Borrar"/></div> </td>';					
						echo '</tr>';
						echo '<tr>';
						echo '<td><div align="center"><a href="subir_actividades.php">Nuevas Actividades</a></div></td>';
						echo '<td><div align="center"><input type="submit" name="actualizaractividades" id="actualizaractividades" value="Actualizar / Borrar" /></div></td>';
						echo '</tr>';
						echo "</table>";
						echo '<br/><a href="totalregistros.php">Ver usuarios registrados en apf web</a>';
						echo '<br/><br/><a href="circulares.php">Click aqui para volver</a>';
					}
				}
			}
			else
		...
		?><?php mysql_close();?>
		<div id="subircircularespadre" style="visibility:hidden">
        	<?php ?>
        </div>
        <div id="subircircularesdirectiva" style="visibility:hidden">
        	<?php ?>
        </div>        
        <div id="actualizar"  style="visibility:hidden">
        <table  width="560" border="1" bordercolor="#999999" >
          <tr>
            <td width="20"><div align="center"><strong>#</strong></div></td>
            <td width="288"><div align="center"><strong>Nombre</strong></div></td>
            <td width="110"><div align="center"><strong>Fecha</strong></div></td>
            <td width="114"><div align="center"><strong>Enlace</strong></div></td>
          </tr>        
        <?php
...
<!-- Este elemento de eliminación siempre debe ir inmediatamente después del div #mainContent para forzar al div #container a que contenga todos los elementos flotantes hijos --><br class="clearfloat" />
      ...
      <div id="footer">
      <p align="center" class="Estilo1 Estilo5">Todos los derechos reservados. © Axioma 15/08/2011.</p>
  <!-- end #footer --></div>
<!-- end #container --></div>
