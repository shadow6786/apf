...
<div id="container">
      ...
      <div id="mainContent">
        <h3>Administracion de actividades</h3>       
        <?php			
			if (isset($_SESSION['alias'])){
				 echo 'Bienvenido : '.$_SESSION['alias'];
					?>
                    <form id="form2" name="form2" method="post" action="guardar_archivo.php"  enctype="multipart/form-data">
					<br/><br/>
					<input type="hidden" name="MAX_FILE_SIZE" value="2000000">
					<input name="archivoactividad" id="archivoactividad" value="Examinar" type="file" />
					<br/><br/>
					<input type="submit" id="cargaractividad" name="cargaractividad" value="Cargar"/>					
					<br/>
					<br/>
					<a href="circulares.php">Click aqui para volver</a>
				 </form><?php
			}
			else
			{
