...
<div id="container">
      ...
      <div id="mainContent">
        <h3>Cargar Circulares Directiva y Padres de familia</h3>
        <form id="form1" name="form1" method="post" action="guardar_archivo.php" enctype="multipart/form-data">
          <label>Cargar Circular para directiva</a>.<br />
          ...
          Cargar Circular para padres.<br />
          <br />
          <input name="archivo1" id="archivo1" value="examinar" type="file" />
          <br />
          </label>
          <p>
            <input type="submit" name="cargar2" id="cargar2" value="Cargar" />           
          </p>
        </form>
  </div>
