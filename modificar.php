...
<a href="http://www.google.com.bo"><img src="Img/google-logo.gif" width="150" height="60" border="0" /></a><br />
      ...
      <div id="mainContent">
		...
		?>
        <br/><br/>
        <table  width="659" height="62" border="1" bordercolor="#999999">
         <tr>
         <td width="196"><div align="center"><strong>Nombre</strong></div></td>
         <td width="144"><div align="center"><strong>Fecha</strong></div></td>
         <td width="297"><div align="center"><strong>Archivo</strong></div></td>
         </tr>
         <tr>
        <td ><input name="nombre" type="text" id="nombre" size="33"  /></td>
        <td><input type="text" name="fecha" id="fecha" /></td>       
        <td><input name="archivo5" type="file" id="archivo5" size="35" /></td>
         </tr>
        </table>
        <br/>
        <input type="submit" name="actualizaractividades" id="actualizaractividades" value="Actualizar"  />
