...
<a href="http://www.google.com.bo"><img src="Img/google-logo.gif" width="150" height="60" border="0"/></a><br />
      ...
      <form action="send.php" method="post" target="_self">
        <table width="515" border="0">
          <tr>
            <td width="30%" height="36"><div align="right"><strong>Su Email: </strong></div></td>
            <td width="357"><label>
              <input name="email" type="text" id="nombrepadre4" size="35" />
            </label></td>
          </tr>
          <tr>
            <td width="30%" height="32"><div align="right"><strong>Nombre Padre:</strong></div></td>
            <td><label>
              <input name="nombrepadre" type="text" id="nombrepadre" size="35" />
            </label></td>
          </tr>
          <tr>
            <td width="30%" height="30"><div align="right"><strong>Nombre Estudiante:</strong></div></td>
            <td><label>
              <input name="nombreestudiante" type="text" id="nombreestudiante" size="35" />
            </label></td>
          </tr>
          <tr>
            <td width="30%" height="36"><div align="right"><strong>Curso:</strong></div></td>
            <td><label>
              <input type="text" name="curso" id="nombrepadre3" />
              </label></td>
          </tr>
          <tr>
            <td width="30%" height="38"><div align="right"><strong>Asunto: </strong></div></td>
        <td><label>
              <input name="asunto" type="text" id="asunto" size="35" />
            </label></td>
          </tr>
          <tr>
            <td height="33"><div align="right"><strong>Destinatario: </strong></div></td>
            <td><input name="textfield" type="text" id="textfield" value="apfcolegioaleman2011@gmail.com" size="35" readonly="readonly" /></td>
          </tr>
          <tr>
            <td height="99"><div align="right"><strong>Mensaje:</strong></div></td>
            <td><textarea name="mensaje" cols="35" rows="4" wrap="virtual" id="mensaje"></textarea></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
