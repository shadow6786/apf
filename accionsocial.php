...
<body class="thrColFixHdr" onload="MM_preloadImages('Img/directorio-2.gif','Img/estatu-y-reglame2.gif','Img/circulares-2.gif','Img/contactenos-2.gif','Img/accion-social.gif')">
...
<div id="container">
      ...
      <div id="menu" >
        <div align="center" ><a href="http://www.apf-alemansc.com.bo"><img src="Img/quienes-somos.gif" width="136" height="30" border="0" id="inicio" onmouseover="MM_swapImage('inicio','','Img/quienes-somos-2.gif',1)" onmouseout="MM_swapImgRestore()"/></a>
        	<a href="directorio.html"><img src="Img/directorio.gif" name="directorio" width="135" height="30" border="0" id="directorio" onmouseover="MM_swapImage('directorio','','Img/directorio-2.gif',1)" onmouseout="MM_swapImgRestore()"/></a>
        	<a href="estatutos.html"><img src="Img/estatuto-y-reglame.gif" name="estatuto" width="140" height="30" border="0" id="estatuto" onmouseover="MM_swapImage('estatuto','','Img/estatu-y-reglame2.gif',1)" onmouseout="MM_swapImgRestore()" /></a>
        	<a href="circulares.php"><img src="Img/circulares.gif" name="circulares" width="135" height="30" border="0" id="circulares" onmouseover="MM_swapImage('circulares','','Img/circulares-2.gif',1)" onmouseout="MM_swapImgRestore()"/></a>
        	<a href="actividades.php"><img src="Img/contactenos.gif" name="actividades" width="135" height="30" border="0" id="actividades" onmouseover="MM_swapImage('actividades','','Img/contactenos-2.gif',1)" onmouseout="MM_swapImgRestore()" /></a>
        	<a href="accionsocial.php"><img src="Img/accion-social2.gif" name="accion-social" width="137" height="30" border="0" onmouseout="MM_swapImgRestore()"/></a>
        	<a href="uniformes.php"><img src="Img/poleras.gif" name="poleras" width="137" height="30" border="0" onmouseover="MM_swapImage('poleras','','Img/poleras-2.gif',1)" onmouseout="MM_swapImgRestore()"/></a>
        	</div>
  	</div>      
      <div id="sidebar1">
...
<a href="http://www.google.com.bo"><img src="Img/google-logo.gif" width="150" height="60" border="0" /></a><br />
      ...
      <div id="mainContent">
		<div style="padding-top: 20px;">
			<h3>Eventos de Acción Social</h3>
			<table border="1" bordercolor="#999999" width="100%">
				...
				<tr>
					...
					<td style="text-align: center;">
						<a href="accion_social/rifa.pdf">ver archivo</a>
					</td>
				</tr>
				<tr>
					<td style="text-align: center;">
					...
					<td style="text-align: center;">
						Ganadores Rifa Solidaria
					</td>
					<td style="text-align: center;">
						<a href="accion_social/ganadores_rifa.pdf">ver archivo</a>
					</td>
				</tr>
				<tr>
					<td style="text-align: center;">
					...
					<td style="text-align: center;">
						<a href="accion_social/GRAN_KERMESSE_TRADICIONAL.pdf">ver archivo</a>
					</td>
				</tr>
			</table>
			<!--
			<a href="actividades/rifa.pdf" target="_blank" >Descargar PDF</a>
			<br />
			<br />
			<img src="actividades/RIFA-OLIVIA.jpg" width="600px" height="900px"/>
      		<!--<embed src="actividades/rifa.pdf" width="600px" height="900px"></embed> -->
      	</div>
