...
<div id="container">
      ...
      <div id="sidebar1">
        <h3>Por que no visitas tambien:</h3>        
      ...
      <form action="guardar_registro.php" method="post" target="_self">
        ...
        <td><label>
              <input name="nombremadre" type="text" id="nombremadre" size="35" />
            </label></td>
          </tr>
          <tr>
      ...
      <p class="Estilo3">Una vez registrado en la base de datos, para cambiar o actualizar la informacion debe hacerlo mediante el menu de <a href="contacto.php">contacto</a> o enviando un correo a <a href="mailto:apfcolegioaleman2011@gmail.com">apfcolegioaleman2011@gmail.com</a>, especificando el dato a actualizar.</p>
      </div>
<!-- Este elemento de eliminación siempre debe ir inmediatamente después del div #mainContent para forzar al div #container a que contenga todos los elementos flotantes hijos --><br class="clearfloat" />
         
      <div id="footer">
      <p align="center" class="Estilo3">Todos los derechos reservados. © Axioma 15/08/2011.</p>
  <!-- end #footer --></div>
<!-- end #container --></div>
    </body>
</html>
