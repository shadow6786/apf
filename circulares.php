...
function mostrarcirculares(formulario)
{
	...
	{
		if(indice==1)
		{ var sesion="<?php echo $_SESSION['alias']?>";
			if(sesion=="")
			{
...
<?
	session_destroy();
?>
	window.location="http://www.apf-alemansc.com.bo";
}
</script>
</head>

<body class="thrColFixHdr" onload="MM_preloadImages('Img/quienes-somos-2.gif','Img/directorio-2.gif','Img/estatu-y-reglame2.gif','Img/contactenos-2.gif')">
...
<div id="container">
      <div id="header">
          ...
          <!-- end #header -->
          <!--/h1>-->
        <a href="http://www.apf-alemansc.com.bo"><img src="Img/encabezado-1000-x-185-px.gif" border="0" width="1000"/></a>
  </div>
      <div id="menu" >
        <div align="center"><a href="http://www.apf-alemansc.com.bo"><img src="Img/quienes-somos.gif" width="136" height="30" border="0" id="Image1" onmouseover="MM_swapImage('Image1','','Img/quienes-somos-2.gif',1)" onmouseout="MM_swapImgRestore()"/></a>
        	...
        	<a href="circulares.php"><img src="Img/circulares-2.gif" width="136" height="30" border="0" /></a>
        	<a href="actividades.php"><img src="Img/contactenos.gif" width="136" height="30"  border="0" id="Image4" onmouseover="MM_swapImage('Image4','','Img/contactenos-2.gif',1)" onmouseout="MM_swapImgRestore()"/></a>
        	<a href="accionsocial.php"><img src="Img/accion-social.gif" name="accion-social" width="137" height="30" border="0" onmouseover="MM_swapImage('accion-social','','Img/accion-social2.gif',1)" onmouseout="MM_swapImgRestore()"/></a>
      ...
      <div id="sidebar1">
          <h3>
          <strong>Por que no visitas tambien:</strong></h3>
      ...
      <div id="mainContent">
		...
		if($user=="")
		{
        	echo '<p>La directiva APF puede iniciar sesion desde <a href="iniciar_sesion.php">aqui</a>.</p>';
			?>
            <form id="form1" name="form1" method="post" action="">
          	<select name="menu" size="1" id="menu" onchange="mostrarcirculares(form1)" >
		...
		{
			echo '<p>Bienbenido '.$user.'</p>';
			echo '<p>Parar cerrar sesion haga click <a href="javascript:salir()">aqui</a>.</p>';
		?>
        <form id="form1" name="form1" method="post" action="">
          <select name="menu" size="1" id="menu" onchange="mostrarcirculares(form1)" >
            <option value="1">Seleccione Circular</option>
